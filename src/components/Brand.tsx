...
export function Brand() {
  return (
    <Link href="/" className="brand" aria-label="@objectifthunes/react-three-pop-up-book home">
      ...
      <span className="brand__text">
        <span className="brand__eyebrow">LIBRARY · REACT POP-UP</span>
        <span className="brand__name">@objectifthunes/react-three-pop-up-book</span>
